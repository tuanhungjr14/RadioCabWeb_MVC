...
namespace RadioCab.DataAccess.Migrations
{
    ...
    [Migration("20231102063426_PAdvertismentApplicationUser")]
    partial class PAdvertismentApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RadioCab.Models.AdvertismentImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RadioCab.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("PAdvertisment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RadioCab.Models.AdvertismentImage", b =>
                {
                    b.HasOne("RadioCab.Models.Advertisment", "Advertisments")
                        .WithMany()
                        .HasForeignKey("AId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
